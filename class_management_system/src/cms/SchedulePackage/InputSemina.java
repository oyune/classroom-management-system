...
public class InputSemina extends javax.swing.JFrame {
    ...
    private void OkBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_OkBtnActionPerformed
        // 특강 및 세미나 등록 버튼 구현
        String grade_num = gradeNum.getText();
        String grade_name = gradeName.getText();
        String pro_name = proName.getText();
        String class_num = classNum.getSelectedItem().toString();
        ...
        String week_day = weekDay.getSelectedItem().toString();
